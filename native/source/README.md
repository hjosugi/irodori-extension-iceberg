...
This directory is a migration staging area for `irodori.iceberg`. The active native
entrypoints live in `src/lib.rs`, and engine behavior lives in `src/driver.rs`. Engine-specific
